...
public class Ocho : MonoBehaviour {
	...
	public GameObject n1, n2, n3, n4, n5,n6, n7, n8, win, menu, next;
	bool figura, ganar;
	bool nodo1, nodo2, nodo3, nodo4, nodo5, nodo6, nodo7, nodo8;
	int c;
	Vector2 mp, np;
	...
	void OnTriggerEnter2D(Collider2D col)
	{
		...
		if (col.gameObject.name == "Nodo5") {
			nodo5 = true;
		}
		if (col.gameObject.name == "Nodo6") {
			nodo6 = true;
		}
		if (col.gameObject.name == "Nodo7") {
			nodo7 = true;
		}
		if (col.gameObject.name == "Nodo8") {
			nodo8 = true;
		}
